...
container: bin/.container-$(DOTFILE_IMAGE)-PROD
...
docker-manifest: docker-manifest-PROD
docker-manifest-%:
...
deploy-to-kind: install-crd-to-kind push-to-kind install
